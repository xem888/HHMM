const mods = {
  ...
  uninstallConfirm: {
    title: "ถอนการติดตั้ง {{name}} หรือไม่?",
    workshop: "ไฟล์ของม็อดจะถูกลบออกจากเกม คุณยังคงติดตามอยู่ จึงติดตั้งใหม่ได้ทุกเมื่อ",
    local: "ม็อดนี้ถูกติดตั้งด้วยตนเอง HHMM จึงไม่มีสำเนาเก็บไว้ ไฟล์จะถูกลบถาวรและไม่สามารถกู้คืนได้",
  },
